...
function app_trainingregistration($scope, app) {
    ...
    $scope.clickSelectedRealization = function(){
        // $scope.what = $scope.data.realizationListDropdown
        app.action('trainingregistration', 'realizationListDropdown.options['+$scope.data.realizationListDropdown+'].clicked');
    };
}
